 ...
 */
export function generateUPIIntentUri(order: Order, customVpa?: string, customName?: string): string {
  const vpa = customVpa || THEATER_VPA;
  const name = customName || THEATER_NAME;
